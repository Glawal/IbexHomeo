...
#ifndef __IBEX_THREAD_OPTIMIZER_H__
#define __IBEX_THREAD_OPTIMIZER_H__
 ...
 */
class ThreadOptimizer /*: private Optimizer*/{
...
public:
	...
	/** type of objective and system*/
	typedef enum {OBJ_MIN,OBJ_MAX,SUB_OBJ_MIN,SUB_OBJ_MAX} Obj;
	 ...
	 *
	 */
	ThreadOptimizer(int n, Ctc& ctc, Bsc& bsc, LoupFinder& finder, CellBufferOptim& buffer,
			int goal_var, ThreadOptimizer::Obj t_obj,
	 ...
	 *
	 * \return the total real (wall) time of last call to optimize(...)
	 */
	...
	ThreadOptimizer::Obj get_obj() const;
...
protected:
	...
	/*search in global_comm the best loup already found*/
	bool best_loup_found();
...
private:
	...
	//ThreadOptimizer(const ThreadOptimizer&); // forbidden
	...
	std::vector<double> uplo_of_epsboxes;
	...
	/** Return the type of objective (minimize, maximize, with or without parameter variation) */
	Obj obj;
};

inline ThreadOptimizer::Status ThreadOptimizer::get_status() const { return status; }

inline double ThreadOptimizer::get_uplo() const { return uplo; }

inline double ThreadOptimizer::get_loup() const { return loup; }

inline const IntervalVector& ThreadOptimizer::get_loup_point() const { return loup_point; }

inline double ThreadOptimizer::get_time() const { return time; }

inline size_t ThreadOptimizer::get_nb_cells() const { return nb_cells; }

inline double ThreadOptimizer::get_obj_rel_prec() const {
...
inline double ThreadOptimizer::get_obj_abs_prec() const {
	return loup-uplo;
}

inline ThreadOptimizer::Obj ThreadOptimizer::get_obj() const { return obj; }

} // end namespace ibex

#endif // __IBEX_THREAD_OPTIMIZER_H__
